"""Tests for lib/image.py -- image building helpers."""
...
class TestGetPackageManifest:
    def test_returns_sorted_package_list(self) -> None:
        ...
        with patch("lib.image._run", return_value=mock_result):
    ...
    def test_passes_container_tag_to_run(self) -> None:
        ...
        with patch("lib.image._run", return_value=mock_result) as mock_run:
