...
_VM_SUBCOMMAND_PARSE_ARGS: dict[str, list[str]] = {
    ...
    "stop-all": [],
    "ssh": ["co1-test"],
    "cp-to": ["co1-test", "/src", "/dest"],
    "cp-from": ["co1-test", "/src", "/dest"],
    "log": ["co1-test"],
    "dmesg": ["co1-test"],
    "lustre-log": ["co1-test"],
...
class TestEnsureToCreateNamespaceContract:
    ...
    def test_ensure_forwards_all_fields_to_create(self, tmp_path: Path) -> None:
        ...
        patches = [
            ...
            patch("ltvm_pkg.vm_commands.ip_for_name", return_value="192.168.100.5"),
            patch("ltvm_pkg.vm_commands.check_ip_collision"),
