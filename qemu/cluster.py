...
def _lustre_libdir(os_family: str = "rhel") -> str:
    """Return the Lustre library directory for the given OS family."""
...
def generate_local_sh(cluster: ClusterInfo, os_family: str = "rhel") -> str:
    ...
    lustre_dir = _lustre_libdir(os_family)
    lines = [
...
def _deploy_one_node(
    node_name: str, build: str, os_family: str = "rhel"
) -> tuple[str, int, str]:
...
def cmd_cluster_deploy(args: argparse.Namespace) -> None:
    ...
    build = str(src)
    os_family = getattr(args, "os_family", "rhel")
