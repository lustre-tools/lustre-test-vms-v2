...
the Rocky mirror and cached in `output/rocky9/cache/`.

Output: `output/rocky9/kernels/<name>/` with vmlinux,
...
`output/rocky9/kernels/`, so they coexist without conflict.
